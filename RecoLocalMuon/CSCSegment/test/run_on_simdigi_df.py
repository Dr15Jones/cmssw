## Process sim digi events with CSC rechit & segment builders - Tim Cox - 16.02.2015
...
# switch to CSCSegAlgoDF
process.cscSegments.algo_type = cms.int32( 3 )

# Turn on segment dumps
# "2" is 3rd algo CSCSegAlgoDF; "0","1","2" are for DF_ME1234_1, DF_ME1234_2, DF_ME1A configs  
process.cscSegments.algo_psets[2].algo_psets[0].CSCDegmentDebug = cms.untracked.bool(True)
process.cscSegments.algo_psets[2].algo_psets[1].CSCSegmentDebug = cms.untracked.bool(True)
process.cscSegments.algo_psets[2].algo_psets[2].CSCDegmentDebug = cms.untracked.bool(True)
